Chinese Restaurant Franchise (CRF) Sampling 
...
Remark: points 1,...,71 ($X_{1i}, i=1,2,...,71$) come from group 1  and points 72,...,119 ($X_{2i}, i=1,2,...,48$) come from group 2.
